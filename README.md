...
- Configure the party duration
- Create a customized shopping plan

### 💰 Budget Management

- Set a target budget
- Calculate estimated shopping costs
...
- Generate a party shopping list
- Update shopping quantities
...
- Budget variance
- Cost per guest
- Department-level cost distribution
- Shopping progress

### 🎙️ Voice Interaction

The application supports interactive voice features for customer assistance and action confirmation.
